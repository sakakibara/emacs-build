...
{
    $inst_url = 'https://github.com/msys2/msys2-installer/releases/download/2023-07-18/msys2-base-x86_64-20230718.sfx.exe'
    $installer_checksum = 'ab9b9a25e92d0c71136c79eeac954f1ce023341224de8d81401439f38c8b9232'
